...
def load_archi(arch, nchannels, nclasses, size=64, dilation=1, atrous_rates=[6,12,18],fixed_cumul=False, additional_parameters=2):
    ...
    if arch == "UNet_causal_5mn_atrous_complexe_rescale":
        from  src.utils.architectures_fcn import UNet_causal_5mn_atrous_complexe_rescale
    ...
    if arch == "UNet_causal_5mn_atrous_complexe_rescale2":
        from  src.utils.architectures_fcn import UNet_causal_5mn_atrous_complexe_rescale2
    ...
    if arch == "UNet_1mn_causal_5mn_atrous":
        from  src.utils.architectures_fcn import UNet_1mn_causal_5mn_atrous
    ...
    if arch == "UNet_pseudo1mn_causal_5mn_atrous":
        from  src.utils.architectures_fcn import UNet_pseudo1mn_causal_5mn_atrous
    ...
    if arch == "UNet_pseudo1mn_causal_5mn_atrous2":
        from  src.utils.architectures_fcn import UNet_pseudo1mn_causal_5mn_atrous2
    ...
    if arch == "DeepLab_causal_5mn":
        from  src.utils.architectures_fcn import DeepLab_causal_5mn
